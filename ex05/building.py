...
def count_text(text: str) -> dict:
    """
    Count upper letters, lower letters, punctuation, spaces, and digits in text.

    Parameters:
    - text (str): the string to analyze

    Returns:
    - dict: counts with keys 'upper', 'lower', 'punct', 'space', 'digit', 'total'
    """
...
def main():
    """Main function: handles command line arguments and prints text analysis."""
    if len(sys.argv) > 2:
